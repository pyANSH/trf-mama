        ...
        <LeftContainer>
{
    InputFeeds.map((feed)=>(
        ...
        <CommonInput value={feed.stateName} placeholder={feed.placeholderText} onChange={feed.onInputChange} />
        </CommonInputContainer>
            ))
}
...
<DropDownAns onClick={()=>setIsGenderDropDownOpen(!isGenderDropDownOpen)}>
    <GenderText>
...
{isGenderDropDownOpen&&<DropDownMainContainer>
...
<input style={{display:'none'}} ref={imageUpload} type={'file'}  />
<UploadProfilePictureBtn onClick={() => imageUpload.current && imageUpload.current.click()}>
Change Avatar
...
<CommonInputContainer>
    ...
    <DropDownAns onClick={()=>setIsInterestDropDownOpen(!isInterestDropDownOpen)}>
    <GenderText>
...
{isInterestDropDownOpen&&<DropDownMainContainer>
